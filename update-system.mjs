...
/**
 * update-system.mjs — Safe auto-updater for jobz
 *
...
const CANONICAL_REPO = 'https://github.com/markiv25/jobz.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/markiv25/jobz/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/markiv25/jobz/releases/latest';
