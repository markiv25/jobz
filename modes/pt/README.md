# jobz -- Modos em Portugues BR (`modes/pt/`)

Esta pasta contem as traducoes em portugues brasileiro dos principais modos do jobz para candidatos que buscam vagas no mercado brasileiro ou em empresas que operam em portugues.
...
O jobz nao tem um "switch de idioma" como flag de codigo. Em vez disso, existem dois caminhos:
