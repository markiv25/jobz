# jobz -- Modes francophones (`modes/fr/`)

Ce dossier contient les traductions francaises des principaux modes jobz pour les candidats qui ciblent le marche francophone (France, Belgique, Suisse romande, Luxembourg, Quebec).
