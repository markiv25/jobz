...
# jobz batch runner — standalone orchestrator for claude -p workers
...
usage() {
  cat <<'USAGE'
jobz batch runner — process job offers in batch via claude -p workers
